            ...
            <tbody>
                @forelse ($tournaments as $tournament)
                    <tr>
                        ...
                        <td class="text-slate-600">{{ $tournament['competition_system_label'] ?? 'Sistem Gugur (Single Elimination)' }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center text-slate-500">Belum ada data turnamen.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
